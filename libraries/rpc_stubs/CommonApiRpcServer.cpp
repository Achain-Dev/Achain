...
namespace thinkyoung {
    namespace rpc_stubs {
        ...
        fc::variant CommonApiRpcServer::blockchain_get_act_account_balance_entry_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            // this method has no prerequisites
            ...
            std::vector<thinkyoung::blockchain::ActTrxidBalance> result = get_client()->blockchain_get_act_account_balance_entry(block_num);
            return fc::variant(result);
        }

        fc::variant CommonApiRpcServer::blockchain_get_act_account_balance_entry_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            // this method has no prerequisites
        ...
        void CommonApiRpcServer::register_common_api_methods(const fc::rpc::json_connection_ptr& json_connection)
        {
           ...
           // register method blockchain_get_act_account_balance_entry
            bound_positional_method = boost::bind(&CommonApiRpcServer::blockchain_get_act_account_balance_entry_positional,
                this, capture_con, _1);
            json_connection->add_method("blockchain_get_act_account_balance_entry", bound_positional_method);
            bound_named_method = boost::bind(&CommonApiRpcServer::blockchain_get_act_account_balance_entry_named, 
                this, capture_con, _1);
            json_connection->add_named_param_method("blockchain_get_act_account_balance_entry", bound_named_method);
        ...
        void CommonApiRpcServer::register_common_api_method_metadata()
        {
            ...
            {
                // register method blockchain_get_act_account_balance_entry
                thinkyoung::api::MethodData blockchain_get_act_account_balance_entry_method_metadata{ "blockchain_get_act_account_balance_entry", nullptr,
                    /* description */ "fetch all ActTrxidBalance from block where blocknum of the block lower than block_num or equal to block_num.",
                    /* returns */ "vector<act_trxid_balance>",
                    /* params: */{
                        {"block_num", "uint32_t", thinkyoung::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (thinkyoung::api::MethodPrerequisites) 0,
                    /* detailed description */ "fetch all ActTrxidBalance from block where blocknum of the block lower than block_num or equal to block_num.\n\nParameters:\n  block_num (uint32_t, required): \n\nReturns:\n  vector<act_trxid_balance>\n",
                    /* aliases */ {}, false};
                store_method_metadata(blockchain_get_act_account_balance_entry_method_metadata);
            }
...

            {
                ...
                thinkyoung::api::MethodData validate_address_method_metadata{ "validate_address", nullptr,
                    /* description */ "Return information about given Act address",
                    /* returns */ "json_object",
                    /* params: */{
                        {"address", "string", thinkyoung::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (thinkyoung::api::MethodPrerequisites) 0,
                    /* detailed description */ "Return information about given Act address\n\nParameters:\n  address (string, required): the address or public key to validate\n\nReturns:\n  json_object\n",
        ...
        fc::variant CommonApiRpcServer::direct_invoke_positional_method(const std::string& method_name, const fc::variants& parameters)
        {
            ...
            if (method_name == "blockchain_get_act_account_balance_entry")
                return blockchain_get_act_account_balance_entry_positional(nullptr, parameters);
