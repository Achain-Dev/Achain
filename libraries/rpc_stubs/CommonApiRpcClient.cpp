...
namespace thinkyoung {
    namespace rpc_stubs {
        ...
        std::vector<thinkyoung::blockchain::ActTrxidBalance> CommonApiRpcClient::blockchain_get_act_account_balance_entry(uint32_t block_num)
        {
            fc::variant result = get_json_connection()->async_call("blockchain_get_act_account_balance_entry", std::vector<fc::variant>{fc::variant(block_num)}).wait();
            return result.as<std::vector<thinkyoung::blockchain::ActTrxidBalance>>();
        }
