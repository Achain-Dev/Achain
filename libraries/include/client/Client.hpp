...
namespace thinkyoung {
    namespace client {
        ...
        struct Config
        {
            ...
            uint16_t            maximum_number_of_connections = ACT_NET_DEFAULT_MAX_CONNECTIONS;
            bool                use_upnp = true;
            ...
            ShareType          min_relay_fee = ACT_BLOCKCHAIN_DEFAULT_RELAY_FEE;
            string              wallet_callback_url;

            ShareType          light_network_fee = ACT_BLOCKCHAIN_DEFAULT_RELAY_FEE;
            ShareType          light_relay_fee = ACT_BLOCKCHAIN_DEFAULT_RELAY_FEE;
            ...
            optional<string>    growl_act_client_identifier;
...
extern const std::string ACT_MESSAGE_MAGIC;
