...
namespace thinkyoung {
    namespace api {
        ...
        public:
            ...
            /**
             * fetch all ActTrxidBalance from block where blocknum of the block lower than block_num or equal to
             * block_num.
             *
             * @param block_num (uint32_t, required)
             *
             * @return vector<act_trxid_balance>
             */
            virtual std::vector<thinkyoung::blockchain::ActTrxidBalance> blockchain_get_act_account_balance_entry(uint32_t block_num) = 0;
            /**
            ...
            /**
             * Initiates the login procedure by providing a Act Login URL.
             *
            ...
            /**
             * Return information about given Act address.
             *
