    ...
    namespace blockchain {
        ...
        namespace detail
        {
            ...
            public:
                ...
                * Get database_version from property database and check whether it equals to ACT_BLOCKCHAIN_DATABASE_VERSION
                ...
                */
                ...
                ShareType                                                                  _relay_fee = ACT_BLOCKCHAIN_DEFAULT_RELAY_FEE;

                /* Block processing */
                uint32_t /* Only used to skip undo states when possible during replay */    _min_undo_block = 0;

                fc::mutex                                                                   _push_block_mutex;
                ShareType															_block_per_account_reword_amount = ACT_MAX_DELEGATE_PAY_PER_BLOCK;
                ...
                thinkyoung::db::fast_level_map<string, set<ActTrxidBalance>>							_act_input_balance_entry;
                thinkyoung::db::fast_level_map<string, ActBalanceEntry>						_act_full_entry;
