...
namespace thinkyoung {
    namespace blockchain {
        ...
        struct ActTrxidBalance
        {
			ActTrxidBalance(){};
			ActTrxidBalance(string act_account, TransactionIdType trx_id, Asset asset_trx, uint32_t
			...
			friend bool operator > (const ActTrxidBalance& acta, const ActTrxidBalance& actb){
				return acta.block_num > actb.block_num;
            }
			friend bool operator < (const ActTrxidBalance& acta, const ActTrxidBalance& actb){
				return acta.block_num < actb.block_num;
            }
        ...
        struct ActBalanceEntry
        {
            std::set<TransactionIdType> act_trxid_sort;
            std::multimap<uint32_t, ActTrxidBalance> act_block_sort;
        };
...
FC_REFLECT_ENUM(thinkyoung::blockchain::TransactionType,
    ...
    FC_REFLECT(thinkyoung::blockchain::ActTrxidBalance, (act_account)(trx_id)(asset_trx)(block_num)(from_account)(create_time))
    FC_REFLECT(thinkyoung::blockchain::ActBalanceEntry, (act_trxid_sort)(act_block_sort))
    FC_REFLECT(thinkyoung::blockchain::Transaction, (expiration)(reserved)(act_account)(act_inport_asset)(operations)(result_trx_type)(result_trx_id))
