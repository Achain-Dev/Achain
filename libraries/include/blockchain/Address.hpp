...
namespace thinkyoung {
    namespace blockchain {
        ...
        public:
			...
			explicit Address(const std::string& base58str, const AddressType& address_type = AddressType::act_address);   ///< converts to binary, validates checksum
            ...
            * @return bool
            */
            static bool is_valid(const std::string& base58str, const std::string& prefix = ACT_ADDRESS_PREFIX);

			std::string AddressToString(const AddressType& address_type = AddressType::act_address)const;
