    ...
    namespace blockchain {
        ...
        public:
            ...
            */
            ...
            /**  Fetch ACT input balance in blocks that block_num of them are lower of the given block_num
            *  or equal to
            *
            * @param  block_num  uint32_t
            *
            * @return vector<ActTrxidBalance>
            */
            vector<ActTrxidBalance> fetch_act_input_balance(const uint32_t &  block_num);

            /**  Insert the ACT transaction balance to db _act_input_balance_entry
            *
            * @param  act_account  string
            * @param  act_balance_entry  ActTrxidBalance
            *
            * @return void
            */
            void transaction_insert_to_act_balance(const string & act_account, const ActTrxidBalance & act_balance_entry);

            /** Erase the ACT transaction balance from db _act_input_balance_entry
            *
            * @param  act_account  string
            * @param  act_balance_entry  ActTrxidBalance
            *
            * @return void
            */
            void transaction_erase_from_act_balance(const string & act_account, const ActTrxidBalance & act_balance_entry);
            vector<ActTrxidBalance> fetch_act_full_entry(const uint32_t& block_num, const uint32_t& last_scan_block_num);
            //Must handle account before you use this function
            void transaction_insert_to_act_full_entry(const string& act_accout, const ActTrxidBalance& act_balance_entry);
            //Must handle account before you use this function
            void transaction_erase_from_act_full_entry(const string& act_accout, const ActTrxidBalance& act_balance_entry);
