...
namespace thinkyoung {
    namespace blockchain {
        ...
        {
            std::string prefix;
            if (address_type == AddressType::act_address)
                prefix = ACT_ADDRESS_PREFIX;
     ...
     //   }
        ...
        Address::operator std::string()const
        {
            ...
            auto checksum = fc::ripemd160::hash((char*)&addr, sizeof(addr));
            memcpy(((char*)&bin_addr) + 20, (char*)&checksum._hash[0], 4);
            return ACT_ADDRESS_PREFIX + fc::to_base58(bin_addr.data, sizeof(bin_addr));
        }
