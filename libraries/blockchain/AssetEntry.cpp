    ...
    namespace blockchain {
        ...
        void AssetEntry::sanity_check(const ChainInterface& db)const
        {
            try {
                ...
                FC_ASSERT(maximum_share_supply >= 0 && maximum_share_supply <= ACT_BLOCKCHAIN_MAX_SHARES, "Invalid max supply");
                ...
                FC_ASSERT(market_fee <= ACT_BLOCKCHAIN_MAX_UIA_MARKET_FEE, "Invalid market fee");
