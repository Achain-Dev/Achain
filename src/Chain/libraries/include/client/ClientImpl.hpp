        ...
        namespace detail {
            ...
            public:
                ...
                */
                ...
                struct unsign_block{
					BlockIdType block_id_1;
					BlockIdType block_id_2;
					FullBlock_v2 block;

                    unsign_block(const BlockIdType& id1, const BlockIdType& id2, const FullBlock_v2& block2)
						:block_id_1(id1), block_id_2(id2), block(block2)
						{}
				};
				...
				typedef boost::multi_index_container< 
					...
					<
                        ...
                        <
                            boost::multi_index::tag<mode1_index>,
                            boost::multi_index::member< unsign_block, BlockIdType, &unsign_block::block_id_1>
						>,
                        boost::multi_index::ordered_unique
                        <
                            boost::multi_index::tag<mode2_index>,
                            boost::multi_index::member< unsign_block, BlockIdType, &unsign_block::block_id_2>
                        >
                    >
				> unsignBlockSet;

				typedef unsignBlockSet::index<mode1_index>::type Id1Index;
                typedef unsignBlockSet::index<mode2_index>::type Id2Index;
				
				unsignBlockSet _unsign_blocks;
				void remove_unsign_block(const BlockIdType& block_id, uint32_t mode);
				void store_unsign_block(const BlockIdType& block_id1, const BlockIdType& block_id2, const FullBlock_v2& block_data);
				const FullBlock_v2 get_unsign_block(const BlockIdType& block_id, uint32_t mode);
