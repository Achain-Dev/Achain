...
FC_REFLECT_ENUM(thinkyoung::api::MethodPrerequisites, (no_prerequisites)(json_authenticated)(wallet_open)(wallet_unlocked)(connected_to_network)(sandbox_open))
FC_REFLECT_ENUM(thinkyoung::api::ParameterClassification, (required_positional)(required_positional_hidden)(optional_positional)(optional_named))
FC_REFLECT(thinkyoung::api::ParameterData, (name)(type)(classification)(default_value))
FC_REFLECT(thinkyoung::api::MethodData, (name)(description)(return_type)(parameters)(prerequisites)(detailed_description)(aliases)(cached))
