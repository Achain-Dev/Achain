...
namespace thinkyoung {
    namespace rpc_stubs {
        ...
        public:
            ...
            thinkyoung::wallet::WalletTransactionEntry wallet_transfer_to_mutisig(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_address, const std::string& address_for_signature1, const std::string& address_for_signature2, const thinkyoung::blockchain::Imessage& memo_message = fc::json::from_string("\"\"").as<thinkyoung::blockchain::Imessage>(), const thinkyoung::wallet::VoteStrategy& strategy = fc::json::from_string("\"vote_recommended\"").as<thinkyoung::wallet::VoteStrategy>()) override;
            thinkyoung::wallet::WalletTransactionEntry wallet_transfer_from_mutisig(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& address_for_signature1, const std::string& address_for_signature2, const std::string& to_address, const thinkyoung::blockchain::Imessage& memo_message = fc::json::from_string("\"\"").as<thinkyoung::blockchain::Imessage>(), const thinkyoung::wallet::VoteStrategy& strategy = fc::json::from_string("\"vote_recommended\"").as<thinkyoung::wallet::VoteStrategy>()) override;
            ...
            thinkyoung::wallet::WalletTransactionEntry wallet_account_update_registration(const std::string& account_name, const std::string& pay_from_account, const fc::variant& public_data = fc::json::from_string("null").as<fc::variant>(), uint8_t delegate_pay_rate = fc::json::from_string("-1").as<uint8_t>(), uint8_t delegate_mode = fc::json::from_string("0").as<uint8_t>()) override;
