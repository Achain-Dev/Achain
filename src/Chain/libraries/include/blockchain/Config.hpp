...
#define ALP_BLOCKCHAIN_SIGN_COUNT_MAX 50

#define ALP_BLOCKCHAIN_V2_FORK_BLOCK_NUM 20

#define ALP_DELEGATE_SKIP_TIME  2 * 60   //2min

#define ALP_DELEGATE_POS_INVALID 1000
