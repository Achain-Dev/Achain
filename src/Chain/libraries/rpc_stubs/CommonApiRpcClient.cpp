...
namespace thinkyoung {
    namespace rpc_stubs {
        ...
        thinkyoung::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_transfer_to_mutisig(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_address, const std::string& address_for_signature1, const std::string& address_for_signature2, const thinkyoung::blockchain::Imessage& memo_message /* = fc::json::from_string("\"\"").as<thinkyoung::blockchain::Imessage>() */, const thinkyoung::wallet::VoteStrategy& strategy /* = fc::json::from_string("\"vote_recommended\"").as<thinkyoung::wallet::VoteStrategy>() */)
        {
            fc::variant result = get_json_connection()->async_call("wallet_transfer_to_mutisig", std::vector<fc::variant>{fc::variant(amount_to_transfer), fc::variant(asset_symbol), fc::variant(from_account_name), fc::variant(to_address), fc::variant(address_for_signature1), fc::variant(address_for_signature2), fc::variant(memo_message), fc::variant(strategy)}).wait();
            return result.as<thinkyoung::wallet::WalletTransactionEntry>();
        }
        thinkyoung::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_transfer_from_mutisig(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& address_for_signature1, const std::string& address_for_signature2, const std::string& to_address, const thinkyoung::blockchain::Imessage& memo_message /* = fc::json::from_string("\"\"").as<thinkyoung::blockchain::Imessage>() */, const thinkyoung::wallet::VoteStrategy& strategy /* = fc::json::from_string("\"vote_recommended\"").as<thinkyoung::wallet::VoteStrategy>() */)
        {
            fc::variant result = get_json_connection()->async_call("wallet_transfer_from_mutisig", std::vector<fc::variant>{fc::variant(amount_to_transfer), fc::variant(asset_symbol), fc::variant(from_account_name), fc::variant(address_for_signature1), fc::variant(address_for_signature2), fc::variant(to_address), fc::variant(memo_message), fc::variant(strategy)}).wait();
            return result.as<thinkyoung::wallet::WalletTransactionEntry>();
        }
