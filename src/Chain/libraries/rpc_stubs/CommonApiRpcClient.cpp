...
namespace thinkyoung {
    namespace rpc_stubs {
        ...
        void CommonApiRpcClient::set_local_pending_num(const uint32_t local_pending_num) {
            fc::variant resutl = get_json_connection()->async_call("set_local_pending_num", std::vector<fc::variant> {fc::variant(local_pending_num)}).wait();
        }
