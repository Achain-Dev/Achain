    ...
    namespace blockchain {
        ...
        ExtendedAddress::ExtendedAddress(const std::string& base58str) {
            try {
                ...
                FC_ASSERT(base58str.size() > prefix_len, "Address must be longer than ABTC_ADDRESS_PREFIX");
                FC_ASSERT(base58str.substr(0, prefix_len) == prefix, "ABTC_ADDRESS_PREFIX must be in front of the address");
