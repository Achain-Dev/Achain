...
namespace thinkyoung {
    namespace client {
        ...
        const string ALP_MESSAGE_MAGIC = "Bbtc Signed Message:\n";
        ...
        */
        ...
        fc::variant_object version_info() {
            ...
            info["abtc_revision"] = thinkyoung::utilities::git_revision_sha;
            info["abtc_revision_age"] = fc::get_approximate_relative_time_string(fc::time_point_sec(thinkyoung::utilities::git_revision_unix_timestamp));
